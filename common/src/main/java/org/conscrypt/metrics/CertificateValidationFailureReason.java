...
public enum CertificateValidationFailureReason {
    UNKNOWN(CERTIFICATE_VALIDATION_FAILURE_REPORTED__REASON__CERTIFICATE_VALIDATION_FAILURE_REASON_UNKNOWN),
    NO_TRUST_ANCHOR(
    ...
    private CertificateValidationFailureReason(int id) {
        this.id = id;
    }
}
