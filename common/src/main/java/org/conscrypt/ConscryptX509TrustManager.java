...
public interface ConscryptX509TrustManager {
    ...
    /**
     * Retrieve the ConscryptNetworkSecurityPolicy attached to this TrustManager.
     */
    default public ConscryptNetworkSecurityPolicy getNetworkSecurityPolicy() {
        return null;
    }
     ...
     */
    default public void setNetworkSecurityPolicy(ConscryptNetworkSecurityPolicy policy) {}
}
