...
public interface HpkeSpi {
     ...
     * @throws IllegalStateException if this SPI has already been initialised
     */
    void engineInitSenderForTesting(PublicKey recipientKey, byte[] info, PrivateKey senderKey,
     ...
     * @throws IllegalStateException if this SPI has already been initialised
     */
    void engineInitRecipient(byte[] encapsulated, PrivateKey recipientKey, byte[] info,
