...
public abstract class HpkeContext {
    ...
    protected static HpkeSpi findSpi(String algorithm, String providerName)
            throws NoSuchAlgorithmException, IllegalArgumentException, NoSuchProviderException {
    ...
    protected static HpkeSpi findSpi(String algorithm, Provider provider)
