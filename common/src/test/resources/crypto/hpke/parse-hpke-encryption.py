...
def parse_and_format(file_in_path: str, file_out_path: str) -> None:
    """
    Parse and formats test-vectors.json into Conscrypt's format.
    ...
    this script. A file will be created named "hpke-encryption.csv"
        ...
        Parameters:
            file_in_path: Absolute path to test-vectors.json.
...
def main():
    ...
    parse_and_format(path / "test-vectors.json", path / "hpke-encryption.csv")
