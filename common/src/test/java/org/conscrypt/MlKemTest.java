...
public class MlKemTest {
    ...
    public void generateKeyPair_works() throws Exception {
        for (String keyGenAlgorithm : new String[] {"ML-KEM", "ML-KEM-768", "ML-KEM-1024"}) {
            ...
            assertThat(rawPublicKey).hasLength(expectedAlgorithm.publicKeySize());
        }
    }
    ...
    public void keyFactory_toAndFromRaw_works() throws Exception {
        for (String factoryAlgorithm : new String[] {"ML-KEM", "ML-KEM-768", "ML-KEM-1024"}) {
            ...
            assertEquals("ML-KEM", privateKey.getAlgorithm());
            assertThat(privateKey.getSeed()).isEqualTo(rawPrivateKey);
            ...
            assertEquals("ML-KEM", publicKey.getAlgorithm());
            assertThat(publicKey.getRaw()).isEqualTo(rawPublicKey);
            ...
            assertThat(privateKeySpec.getEncoded()).isEqualTo(rawPrivateKey);
            ...
            assertThat(publicKeySpec.getEncoded()).isEqualTo(rawPublicKey);
    ...
    public void mlKem768KeyPair_x509AndPkcs8_works() throws Exception {
        ...
        assertThat(keyPair.getPrivate().getEncoded()).hasLength(86);

        assertThat(keyPair.getPublic().getFormat()).isEqualTo("X.509");
        // 1184 bytes for the raw key + 22 bytes for the preamble.
        assertThat(keyPair.getPublic().getEncoded()).hasLength(1206);
        ...
        for (String algorithm : new String[] {"ML-KEM-768", "ML-KEM"}) {
            ...
            assertThat(privateKeySpec.getFormat()).isEqualTo("PKCS#8");
            assertThat(privateKeySpec.getEncoded()).isEqualTo(keyPair.getPrivate().getEncoded());

            X509EncodedKeySpec publicKeySpec =
                    keyFactory.getKeySpec(keyPair.getPublic(), X509EncodedKeySpec.class);
            assertThat(publicKeySpec.getFormat()).isEqualTo("X.509");
            assertThat(publicKeySpec.getEncoded()).isEqualTo(keyPair.getPublic().getEncoded());
            ...
            assertThat(keyFactory.translateKey(keyPair.getPrivate()))
                    .isEqualTo(keyPair.getPrivate());
            assertThat(
                    keyFactory.translateKey(new TestPrivateKey(keyPair.getPrivate().getEncoded())))
                    .isEqualTo(keyPair.getPrivate());
            assertThat(keyFactory.translateKey(keyPair.getPublic())).isEqualTo(keyPair.getPublic());
            assertThat(keyFactory.translateKey(new TestPublicKey(keyPair.getPublic().getEncoded())))
    ...
    public void mlKem1024KeyPair_x509AndPkcs8_works() throws Exception {
        ...
        assertThat(keyPair.getPublic().getEncoded()).hasLength(1590);
    ...
    public void mlKem768_pkcs8TestVector_works() throws Exception {
        ...
        assertThat(privateKey.getEncoded()).isEqualTo(encoded);

        EncodedKeySpec encodedKeySpec =
                keyFactory.getKeySpec(privateKey, PKCS8EncodedKeySpec.class);
        assertThat(encodedKeySpec.getFormat()).isEqualTo("PKCS#8");
        assertThat(encodedKeySpec.getEncoded()).isEqualTo(encoded);

        PrivateKey privateKey2 = keyFactory.generatePrivate(new PKCS8EncodedKeySpec(encoded));
        assertThat(privateKey2.getEncoded()).isEqualTo(encoded);
        OpenSslMlKemPrivateKey mlKemPrivateKey = (OpenSslMlKemPrivateKey) privateKey2;
        assertThat(mlKemPrivateKey.getMlKemAlgorithm()).isEqualTo(MlKemAlgorithm.ML_KEM_768);
        assertThat(mlKemPrivateKey.getSeed()).isEqualTo(seed);
    }
    ...
    public void mlKem1024_pkcs8TestVector_works() throws Exception {
        ...
        assertThat(privateKey2.getEncoded()).isEqualTo(encoded);
        OpenSslMlKemPrivateKey mlKemPrivateKey = (OpenSslMlKemPrivateKey) privateKey2;
        assertThat(mlKemPrivateKey.getMlKemAlgorithm()).isEqualTo(MlKemAlgorithm.ML_KEM_1024);
        assertThat(mlKemPrivateKey.getSeed()).isEqualTo(seed);
    }
    ...
    public void mlKem768_x509TestVector_works() throws Exception {
        ...
        assertThat(publicKey.getEncoded()).isEqualTo(encoded);

        EncodedKeySpec encodedKeySpec = keyFactory.getKeySpec(publicKey, X509EncodedKeySpec.class);
        assertThat(encodedKeySpec.getFormat()).isEqualTo("X.509");
        assertThat(encodedKeySpec.getEncoded()).isEqualTo(encoded);

        PublicKey publicKey2 = keyFactory.generatePublic(new X509EncodedKeySpec(encoded));
        assertThat(publicKey2.getEncoded()).isEqualTo(encoded);
        OpenSslMlKemPublicKey mlKemPublicKey = (OpenSslMlKemPublicKey) publicKey2;
        assertThat(mlKemPublicKey.getMlKemAlgorithm()).isEqualTo(MlKemAlgorithm.ML_KEM_768);
        assertThat(mlKemPublicKey.getRaw()).isEqualTo(raw);
    }
    ...
    public void mlKem1024_x509TestVector_works() throws Exception {
        ...
        assertThat(publicKey2.getEncoded()).isEqualTo(encoded);
        OpenSslMlKemPublicKey mlKemPublicKey = (OpenSslMlKemPublicKey) publicKey2;
        assertThat(mlKemPublicKey.getMlKemAlgorithm()).isEqualTo(MlKemAlgorithm.ML_KEM_1024);
        assertThat(mlKemPublicKey.getRaw()).isEqualTo(raw);
    }
    ...
    public void wrongInfoORAad_fails() throws Exception {
        ...
        assertThat(contextRecipient.open(ciphertext, aad)).isEqualTo(plaintext);
    ...
    public void hpkeContextRecipient_openTestVectors_works() throws Exception {
        ...
        for (TestVector vector : vectors) {
            ...
            assertThat(decrypted).isEqualTo(pt);
            ...
            assertThat(output).isEqualTo(pt);
        }
    }
