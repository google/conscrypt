...
public class OpaqueProvider extends Provider {
    ...
    private static class OpaqueDelegatingMarkedECPrivateKey
            extends OpaqueDelegatingECPrivateKey implements ECPrivateKey {
    ...
    private static class OpaqueDelegatingMarkedRSAPrivateKey
            extends OpaqueDelegatingRSAPrivateKey implements RSAPrivateKey {
