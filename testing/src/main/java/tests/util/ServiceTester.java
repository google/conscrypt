...
public final class ServiceTester {
    ...
    public static ServiceTester test(String service) {
        if (service.equalsIgnoreCase("Cipher")) {
            ...
            // to check for a lot of combinations (eg, a test for AES/CBC/NoPadding might be
            // satisfied by a provider providing AES, AES/CBC, AES//NoPadding, or
            // AES/CBC/NoPadding).  We don't really need it, so we haven't implemented it.
