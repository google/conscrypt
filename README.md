...
dependencies {
  compile 'org.conscrypt:conscrypt-openjdk:2.2.0:' + osdetector.classifier
}
```
...
```gradle
dependencies {
  compile 'org.conscrypt:conscrypt-openjdk-uber:2.2.0'
}
```
...
```gradle
dependencies {
  implementation 'org.conscrypt:conscrypt-android:2.2.0'
}
```
