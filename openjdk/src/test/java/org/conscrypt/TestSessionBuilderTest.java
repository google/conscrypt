...
public class TestSessionBuilderTest {
    ...
    public void buildsValidOcspSession() {
        assertArrayEquals(
                new byte[] {
                        0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x01, 0x22,
                        0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x33,
                        0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x44,
                },
                new TestSessionBuilder()
                        .setType(0x11)
                        .setSessionData(new byte[] {0x22})
    ...
    public void buildsValidOcspAndTlsSctSession() {
        assertArrayEquals(
                new byte[] {
                        0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x01, 0x22, 0x00, 0x00,
                        0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x33, 0x00, 0x00, 0x00, 0x01,
                        0x00, 0x00, 0x00, 0x01, 0x44, 0x00, 0x00, 0x00, 0x01, 0x55,
                },
                new TestSessionBuilder()
                        .setType(0x11)
                        .setSessionData(new byte[] {0x22})
    ...
    public void buildsInvalidOcspAndTlsSctSession() {
        assertArrayEquals(
                new byte[] {
                        0x00, 0x00, 0x00, 0x11,        0x00,        0x33, 0x22, 0x11,
                        0x22, 0x12, 0x11, 0x22,        0x34,        0x10, 0x20, 0x30,
                        0x40, 0x33, 0x38, 0x48,        0x18,        0x28, 0x13, 0x24,
